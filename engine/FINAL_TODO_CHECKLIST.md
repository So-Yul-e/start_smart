...
### 2. 문서화 ⚠️ **협업 필수**
- [ ] API 문서 작성 (Breakdown 포함)
- [ ] 백엔드 통합 가이드 (비동기 처리 포함)
...
### Phase 1
- [x] Step 1.4: Finance 출력 형식 검증 ✅ (완료)

### Phase 2
- [x] Step 2.6: Decision 출력 형식 검증 ✅ (완료)
- [x] Score breakdown 추가 ✅ (완료)
- [x] Survival months 보너스 규칙 ✅ (완료)

### 추가 완료
- [x] 데이터베이스 연동 ✅ (완료)
- [x] 모든 fixture 파일 async/await 적용 ✅ (완료)
...
- [ ] 단위 테스트 (Finance + Decision) ⚠️ **가장 중요**
- [x] 데이터베이스 연동 ✅
- [x] Score breakdown ✅
